...
import {
 ...
 PlatformTrustBanner,FeaturedProducts,Testimonials,ConversionCard,BrandTrustBar,Footer
 ...
 return (
  <div className="min-h-screen bg-[#f8fafc] text-[#111329]">
   ...
   <main id="main-content">
    ...
    <PromotionalBanners/>
    <PlatformTrustBanner/>
    <div className="mx-auto grid max-w-[1500px] grid-cols-1 gap-5 px-5 pt-5 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] lg:gap-4 lg:px-8">
